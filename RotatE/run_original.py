...
def main(args):
    ...
    entity2id = load_dict(args.data_path, 'entities.dict')
    relation2id = load_dict(args.data_path, 'relations.dict')
    ...
    train_triples = read_triple(os.path.join(args.data_path, 'train.txt'), entity2id=entity2id, relation2id=relation2id)
    logging.info('#train: %d' % len(train_triples))
    valid_triples = read_triple(os.path.join(args.data_path, 'valid.txt'), entity2id=entity2id, relation2id=relation2id)
    logging.info('#valid: %d' % len(valid_triples))
    test_triples = read_triple(os.path.join(args.data_path, 'test.txt'), entity2id=entity2id, relation2id=relation2id)
    logging.info('#test: %d' % len(test_triples))
    # print(TAG2, '[train_triples]', train_triples[:10])
    # print(TAG2, '[valid_triples]', valid_triples[:10])
    # print(TAG2, '[test_triples]', test_triples[:10])
