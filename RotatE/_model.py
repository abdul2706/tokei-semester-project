...
try:
    ...
    from _dataloader import TestDataset
...
class KGEModel(nn.Module):
    ...
    @staticmethod
    def TransE(head, relation, tail, mode, embedding_range=None, gamma=None, modulus=None):
        if mode == 'head-batch':
    ...
    @staticmethod
    def DistMult(head, relation, tail, mode, embedding_range=None, gamma=None, modulus=None):
        if mode == 'head-batch':
            score = head * (relation * tail)
        else:
            score = (head * relation) * tail
    ...
    @staticmethod
    def ComplEx(head, relation, tail, mode, embedding_range=None, gamma=None, modulus=None):
    ...
    @staticmethod
    def RotatE(head, relation, tail, mode, embedding_range=None, gamma=None, modulus=None):
    ...
    @staticmethod
    def pRotatE(head, relation, tail, mode, embedding_range=None, gamma=None, modulus=None):
